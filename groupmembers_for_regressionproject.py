...
studentdf = pd.read_sql('SELECT * FROM student_groups WHERE student_id = 673', conn)
#print(df)

#  my group 4
groupdf = pd.read_sql('SELECT * FROM student_groups WHERE group_id = 4', conn)
#print(groupdf)

#  students in group 4

student_groupdf = pd.read_sql('SELECT * FROM students WHERE student_id = 664 OR student_id = 668 OR student_id = 670 OR student_id = 664 OR student_id = 673', conn)
